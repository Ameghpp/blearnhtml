...
// a[0].innerText="goodMorning";
// a[0].style.color="blue";


// //get element by name
// let b=document.getElementsByTagName("p");
// b[0].innerHTML="goodNight";
// b[0].style.color="red";
// b[0].style.fontSize="3rem";
// console.log(b);

// let a=document.querySelectorAll(".hclass");
// a[1].innerHTML = "learning java"
// a[0].innerHTML="Learning";
// a[1].style.color="red";


//let a=document.getElementsByName("text")[0];
